...
class Ship(commands.Cog):
    ...
    def create_ship_card(self, avatar1_bytes, avatar2_bytes, percentage):
        ...
        # Increased canvas size to prevent clipping for the massive font
        text_canvas = Image.new('RGBA', (1000, 600), (0, 0, 0, 0))
        t_draw = ImageDraw.Draw(text_canvas)
        
        # Font handling - Increased base size to 450 (Even bigger than before)
        f_size = 450 
        try:
        ...
        t_draw.text((500, 300), text_str, fill="white", font=font_pct, anchor="mm", stroke_width=12, stroke_fill="black")
        ...
        if font_pct.getbbox(text_str)[2] < 100: 
            ...
            # Offsets adjusted for the larger 1000x600 text_canvas
